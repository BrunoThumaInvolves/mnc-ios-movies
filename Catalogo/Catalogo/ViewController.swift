...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        catalogo.addMovie(name: "Resident Evil 2: Apocalipse", year: 2008, rating: "16", genre: "Ficção")
        catalogo.addMovie(name: "Senhor dos Anéis - A Sociedade do Anel", year: 2001, rating: "12", genre: "Fantasia")
        catalogo.addMovie(name: "Harry Potter - As Relíquias da Morte", year: 2010, rating: "12", genre: "Ficção")
        catalogo.addMovie(name: "Star Wars - O Despertar da Força", year: 2015, rating: "12", genre: "Ficção")
        catalogo.addMovie(name: "A fantástica Fábrica de Chocolate", year: 2005, rating: "L", genre: "Ficção")
        catalogo.addMovie(name: "Oh Ramona", year: 2019, rating: "16", genre: "Romance")
        catalogo.addMovie(name: "A Procura da Felicidade", year: 2006, rating: "L", genre: "Drama")
        catalogo.addMovie(name: "Família do Bagulho", year: 2014, rating: "14", genre: "Comédia")
        catalogo.addMovie(name: "Shrek Terceiro", year: 2007, rating: "L", genre: "Comédia")
        catalogo.addMovie(name: "Esquadrão Suicida", year: 2016, rating: "12", genre: "Ação")
        catalogo.addMovie(name: "Onde Está Segunda", year: 2017, rating: "16", genre: "Ação")
